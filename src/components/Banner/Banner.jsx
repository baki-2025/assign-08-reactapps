        ...
        <div className='bg-gray-200 text-black justify-items-center'>
            <div className='justify-center'>
                ...
                <div className='flex justify-center gap-4 p-6 '>
                    ...
                    <button className=' gap-3 bg-white shadow-md border border-gray-300 rounded-xl w-[200px] h-[56px] hover:shadow-lg transition w-[200px] h-[56px] flex items-center justify-center '><img src={appstore} alt="App Store" className="w-6 h-6" />
